...
struct VariantShredderOptions {
    ...
    // Compaction may feed one already-extracted Variant leaf to the shredder. This in-memory
    // context restores the leaf's path for exact predefined-type lookup; ordinary root writers
    // leave it empty.
