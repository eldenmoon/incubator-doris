...
// Native storage writer for ColumnVariantV2. Variant values are incrementally shredded at each
// append; the writer never retains a segment-sized copy of the input execution column.
...
private:
    Status _write_root(const VariantShreddedColumns& shredded, int& column_id);
