...
// compactly beside their ordered logical row ids; missing rows are materialized only for paths
// selected as physical subcolumns. The builder owns every byte after append returns.
