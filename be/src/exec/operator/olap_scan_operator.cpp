...
Status OlapScanLocalState::_init_profile() {
    ...
    _variant_index_scan_terms_counter =
            ADD_COUNTER_WITH_LEVEL(_segment_profile, "VariantIndexScanTerms", TUnit::UNIT, 1);
    _variant_index_scan_postings_counter =
            ADD_COUNTER_WITH_LEVEL(_segment_profile, "VariantIndexScanPostings", TUnit::UNIT, 1);
