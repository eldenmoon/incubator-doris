...
using NestedGroupsMap = std::unordered_map<vectorized::PathInData, std::shared_ptr<NestedGroup>,
                                           vectorized::PathInData::Hash>;
...
private:
    ...
    Status _process_object_field(const doris::JsonbValue* obj_value,
                                 const vectorized::PathInData& next_prefix, NestedGroup& group,
