...
enum class IndexLayout : uint8_t { ALL_VALUES, CHILDREN, NO_INDEX };
    ...
    if (has_inverted_index(layout)) {
        ...
        if (is_single_root_layout(layout)) {
            (*index->mutable_properties())[std::string(
                    segment_v2::variant_root_index::VARIANT_INDEX_SCOPE_KEY)] =
                    segment_v2::variant_root_index::VARIANT_INDEX_SCOPE_VALUES;
            (*index->mutable_properties())[std::string(
