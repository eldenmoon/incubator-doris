...
protected:
    void SetUp() override {
        ...
        {
            JsonbWriter writer;
            Decimal64 dec = Decimal64(static_cast<Int64>(1234567890123456789));
        ...
        {
            JsonbWriter writer;
            Decimal128V3 dec = Decimal128V3(static_cast<Int64>(1234567890123456789));
        ...
        {
            JsonbWriter writer;
            Decimal256 dec {static_cast<Int64>(1234567890123456789)};
