...
TEST(RuntimeProfileTest, Basic) {
    ...
    counter_a->set(static_cast<int64_t>(1));
...
TEST(RuntimeProfileTest, DerivedCounters) {
    ...
    // set to 1 sec
    ticks_counter->set(static_cast<int64_t>(1000LL * 1000LL * 1000LL));
    ...
    bytes_counter->set(static_cast<int64_t>(10));
    EXPECT_EQ(throughput_counter->value(), 10);
    bytes_counter->set(static_cast<int64_t>(20));
