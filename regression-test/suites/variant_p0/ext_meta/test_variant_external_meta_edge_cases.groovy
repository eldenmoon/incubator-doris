...
suite("test_variant_external_meta_edge_cases", "nonConcurrent") {
    ...
    sql """insert into test_empty_subcolumns values (1, parse_to_variant('{}'))"""
    sql """insert into test_empty_subcolumns values (2, parse_to_variant('null'))"""
    sql """insert into test_empty_subcolumns values (3, parse_to_variant('[]'))"""
    ...
    for (int row = 0; row < 10; row++) {
        ...
        sql """insert into test_many_subcolumns values (${row}, parse_to_variant('${json}'))"""
    }
    ...
    sql """insert into test_mixed_format values (1, parse_to_variant('{"a": 1, "b": 2}'))"""
    sql """insert into test_mixed_format values (2, parse_to_variant('{"a": 10, "c": 3}'))"""
    
    // Switch to new format (V2.1) and write more rows
    sql """insert into test_mixed_format values (3, parse_to_variant('{"a": 100, "d": 4}'))"""
    sql """insert into test_mixed_format values (4, parse_to_variant('{"a": 1000, "e": 5}'))"""
    ...
    sql """insert into test_nested_external values (1, parse_to_variant('{"nested": {"level1": {"level2": "value"}}}'))"""
    sql """insert into test_nested_external values (2, parse_to_variant('{"nested": {"level1": {"level2": "value2", "level2_b": 123}}}'))"""
    sql """insert into test_nested_external values (3, parse_to_variant('{"nested": {"level1": null}}'))"""
    sql """insert into test_nested_external values (4, parse_to_variant('{"nested": null}'))"""
    ...
    sql """insert into test_array_external values (1, parse_to_variant('{"arr": [1, 2, 3]}'))"""
    sql """insert into test_array_external values (2, parse_to_variant('{"arr": [10, 20, 30, 40]}'))"""
    sql """insert into test_array_external values (3, parse_to_variant('{"arr": []}'))"""
    sql """insert into test_array_external values (4, parse_to_variant('{"arr": null}'))"""
    ...
    sql """insert into test_schema_evolution values (1, parse_to_variant('{"a": 1}'))"""
    
    // Segment 2: add field 'b'
    sql """insert into test_schema_evolution values (2, parse_to_variant('{"a": 2, "b": 2}'))"""
    
    // Segment 3: add field 'c'
    sql """insert into test_schema_evolution values (3, parse_to_variant('{"a": 3, "b": 3, "c": 3}'))"""
    
    // Segment 4: completely different schema
    sql """insert into test_schema_evolution values (4, parse_to_variant('{"x": 10, "y": 20}'))"""
    ...
    sql """insert into test_special_chars values (1, parse_to_variant('{"field-with-dash": 1}'))"""
    sql """insert into test_special_chars values (2, parse_to_variant('{"field.with.dot": 2}'))"""
    sql """insert into test_special_chars values (3, parse_to_variant('{"field_with_underscore": 3}'))"""
    ...
    sql """insert into test_null_handling values (1, parse_to_variant('{"a": null}'))"""
    sql """insert into test_null_handling values (2, parse_to_variant('{"a": 1}'))"""
    ...
    sql """insert into test_large_strings values (1, parse_to_variant('{"large_field": "${largeString}"}'))"""
    sql """insert into test_large_strings values (2, parse_to_variant('{"large_field": "small"}'))"""
    ...
    sql """insert into test_config_toggle values (1, parse_to_variant('{"a": 1}'))"""
    
    // Switch to legacy (V2)
    sql """insert into test_config_toggle values (2, parse_to_variant('{"a": 2, "b": 2}'))"""
    
    // Enable again (V2.1)
    sql """insert into test_config_toggle values (3, parse_to_variant('{"a": 3, "b": 3, "c": 3}'))"""
