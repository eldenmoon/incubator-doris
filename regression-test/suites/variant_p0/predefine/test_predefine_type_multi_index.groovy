...
suite("test_variant_predefine_type_multi_index", "p0"){
    ...
    sql """insert into ${tableName} values(1, parse_to_variant('{"path" : {"int" : 123, "decimal" : 123.123456789012, "string" : "hello"}, "unsafe" : []}')),
                                          (2, parse_to_variant('{"path" : {"int" : 456, "decimal" : 456.456789123456, "string" : "world"}, "unsafe" : []}')),
                                          (3, parse_to_variant('{"path" : {"int" : 789, "decimal" : 789.789123456789, "string" : "hello"}, "unsafe" : []}')),
                                          (4, parse_to_variant('{"path" : {"int" : 100, "decimal" : 100.100123456789, "string" : "world"}, "unsafe" : []}')),
                                          (5, parse_to_variant('{"path" : {"int" : 111, "decimal" : 111.111111111111, "string" : "hello"}, "unsafe" : []}'))"""
