...
suite("test_schema_template_auto_cast", "p0") {
    ...
    sql """insert into ${tableName} values(1, parse_to_variant('{"num_a": 10, "num_b": 20, "str_name": "alice"}'))"""
    sql """insert into ${tableName} values(2, parse_to_variant('{"num_a": 30, "num_b": 40, "str_name": "bob"}'))"""
    sql """insert into ${tableName} values(3, parse_to_variant('{"num_a": 50, "num_b": 60, "str_name": "charlie"}'))"""
    sql """insert into ${tableName} values(4, parse_to_variant('{"num_a": 15, "num_b": 25, "str_name": "alice"}'))"""
    ...
    test {
        ...
        exception "Variant does not support ordering/comparison, CAST to a concrete type first"
    }
    sql """ set enable_variant_schema_auto_cast = true """
    ...
    sql """insert into ${leftTable} values(1, parse_to_variant('{"key_id": 100}'))"""
    sql """insert into ${leftTable} values(2, parse_to_variant('{"key_id": 200}'))"""
    sql """insert into ${leftTable} values(3, parse_to_variant('{"key_id": 300}'))"""

    sql """insert into ${rightTable} values(1, parse_to_variant('{"key_id": 100, "name_val": "first"}'))"""
    sql """insert into ${rightTable} values(2, parse_to_variant('{"key_id": 200, "name_val": "second"}'))"""
    sql """insert into ${rightTable} values(3, parse_to_variant('{"key_id": 400, "name_val": "fourth"}'))"""
    ...
    sql """insert into ${exactTable} values(1, parse_to_variant('{"exact_key": 10, "glob_1": 20, "glob_2": 5}'))"""
    sql """insert into ${exactTable} values(2, parse_to_variant('{"exact_key": 30, "glob_2": 40}'))"""
    ...
    sql """insert into ${leafTable} values
        (1, parse_to_variant('{"int_1": 1, "int_nested": {"level1_num_1": 1011111, "level1_num_2": 102}}')),
        (2, parse_to_variant('{"int_1": 2, "int_nested": {"level1_num_1": 2022222, "level1_num_2": 202}}')),
        (3, parse_to_variant('{"int_1": 1, "int_nested": {"level1_num_1": 3033333, "level1_num_2": 302}}')),
        (4, parse_to_variant('{"int_1": 3, "int_nested": {"level1_num_1": 4044444, "level1_num_2": 402}}'))"""
    ...
    sql """insert into ${globWildTable} values(1, parse_to_variant('{\"a*b\": 1, \"axb\": 2}'))"""
    sql """insert into ${globLiteralTable} values(1, parse_to_variant('{\"a*b\": 1, \"axb\": 2}'))"""
    ...
    sql """insert into ${castChainTable} values(1, parse_to_variant('{\"num_a\": 10, \"num_b\": 20, \"str_name\": \"alice\"}'))"""
    sql """insert into ${castChainTable} values(2, parse_to_variant('{\"num_a\": 30, \"num_b\": 40, \"str_name\": \"bob\"}'))"""
    sql """insert into ${castChainTable} values(3, parse_to_variant('{\"num_a\": 50, \"num_b\": 60, \"str_name\": \"charlie\"}'))"""
    sql """insert into ${castChainTable} values(4, parse_to_variant('{\"num_a\": 15, \"num_b\": 25, \"str_name\": \"alice\"}'))"""
