...
suite("test_compaction_variant_predefine_with_sparse_limit", "nonConcurrent") {
    ...
    try {
        ...
        for (int i = 0; i < key_types.size(); i++) {
            def tableName = "simple_variant_${key_types[i]}"
            def insert2 = {
                sql """insert into ${tableName} values (1, parse_to_variant('{"sala" : 0.1, "ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1022,  parse_to_variant('{"ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1029,  parse_to_variant('{"a" : 1, "b" : {"c" : 1}}'));"""
                sql """insert into ${tableName} values (2, parse_to_variant('{"sala" : 0.1, "ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1022,  parse_to_variant('{"ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1029,  parse_to_variant('{"a" : 1, "b" : {"c" : 1}}'));"""
                sql """insert into ${tableName} values (3, parse_to_variant('{"sala" : 0.1, "ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1022,  parse_to_variant('{"ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1029,  parse_to_variant('{"a" : 1, "b" : {"c" : 1}}'));"""
                sql """insert into ${tableName} values (4, parse_to_variant('{"sala" : 0.1, "ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1022,  parse_to_variant('{"ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1029,  parse_to_variant('{"a" : 1, "b" : {"c" : 1}}'));"""
                sql """insert into ${tableName} values (5, parse_to_variant('{"sala" : 0.1, "ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1022,  parse_to_variant('{"ddd" : 1, "z" : 10, "a" : 1, "b" : {"c" : 1}}')),(1029,  parse_to_variant('{"a" : 1, "b" : {"c" : 1}}'));"""
            }
            insert2.call();
            insert2.call();
            trigger_and_wait_compaction(tableName, "cumulative", 1800)
