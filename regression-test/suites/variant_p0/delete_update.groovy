...
suite("regression_test_variant_delete_and_update", "variant_type"){
    ...
    //         sql """update ${table_name} set v = '{"updated_value" : 1111}' where k = ${x} """
    //         sql """update ${table_name} set vs = '{"updated_value" : 123}' where k = ${x} """
    //     } 
    // }
    ...
    //         sql """update ${table_name} set v = '{"updated_value" : 1111}' where k = ${x} """
    //         sql """update ${table_name} set vs = '{"updated_value" : 456}' where k = ${x} """
    //     }
    // }
    // t1.join()
    // t2.join()
