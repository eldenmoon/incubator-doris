...
suite("regression_test_variant_complexjson", "variant_type_complex_json") {
    ...
    sql """insert into ${table_name} values (1, parse_to_variant('{
    "id": 1,
    "key_0":[
        {
            "key_1":[
    ...
    create_table table_name
    sql """INSERT INTO ${table_name} VALUES (1, parse_to_variant('{"key_10":65536,"key_11":"anve","key_0":{"key_1":{"key_2":1025,"key_3":1},"key_4":1,"key_5":256}}'))"""
    sql """INSERT INTO ${table_name} VALUES (2, parse_to_variant('{"key_0":[{"key_12":"buwvq","key_11":0.0000000255}]}'))"""
