...
suite("regression_test_variant_add_multi_var_mulit_indexes", "variant_type"){
    ...
    """
    sql """insert into  ${table_name} values (0, parse_to_variant('{"a" : 12345,"b" : 2}'))"""

    sql """ alter table  ${table_name} add column v2 variant<'a': string, 'b': string> NULL"""

    sql """insert into  ${table_name} values (1, parse_to_variant('{"a" : 12345,"b" : 2}'), parse_to_variant('{"a" : 12345,"b" : 3}'))"""

    sql """alter table  ${table_name} add column v3 variant NULL"""

    sql """insert into  ${table_name} values (2, parse_to_variant('{"a" : 12345,"b" : 2}'), parse_to_variant('{"a" : 56789,"b" : 3}'), parse_to_variant('{"a" : 12345,"b" : 2}'))"""
    ...
    sql """insert into  ${table_name} values (3, parse_to_variant('{"a" : 12345,"b" : 2}'), parse_to_variant('{"a" : 12345,"b" : 2}'), parse_to_variant('{"a" : 56789,"b" : 2}'))"""

    sql """insert into  ${table_name} values (4, parse_to_variant('{"a" : 12345,"b" : 2}'), parse_to_variant('{"a" : 56789,"b" : 2}'), parse_to_variant('{"a" : 12345,"b" : 3}'))"""
