...
suite("regression_test_variant", "p0"){
    ...
    try {
        ...
        for (int i = 0; i < key_types.size(); i++) {
            ...
            sql """insert into ${table_name} values (1, parse_to_variant('[1]')),(1, parse_to_variant('{"a" : 1}'));"""
            sql """insert into ${table_name} values (2, parse_to_variant('[2]')),(1, parse_to_variant('{"a" : [[[1]]]}'));"""
            sql """insert into ${table_name} values (3, parse_to_variant('3')),(1, parse_to_variant('{"a" : 1}')), (1, parse_to_variant('{"a" : [1]}'));"""
            sql """insert into ${table_name} values (4, parse_to_variant('"4"')),(1, parse_to_variant('{"a" : "1223"}'));"""
            sql """insert into ${table_name} values (5, parse_to_variant('5')),(1, parse_to_variant('{"a" : [1]}'));"""
            sql """insert into ${table_name} values (6, parse_to_variant('"[6]"')),(1, parse_to_variant('{"a" : ["1", 2, 1.1]}'));"""
            sql """insert into ${table_name} values (7, parse_to_variant('7')),(1, parse_to_variant('{"a" : 1, "b" : {"c" : 1}}'));"""
            sql """insert into ${table_name} values (8, parse_to_variant('8.11111')),(1, parse_to_variant('{"a" : 1, "b" : {"c" : [{"a" : 1}]}}'));"""
            sql """insert into ${table_name} values (9, parse_to_variant('"9999"')),(1, parse_to_variant('{"a" : 1, "b" : {"c" : [{"a" : 1}]}}'));"""
            sql """insert into ${table_name} values (10, parse_to_variant('1000000')),(1, parse_to_variant('{"a" : 1, "b" : {"c" : [{"a" : 1}]}}'));"""
            sql """insert into ${table_name} values (11, parse_to_variant('[123.1]')),(1999, parse_to_variant('{"a" : 1, "b" : {"c" : 1}}')),(19921, parse_to_variant('{"a" : 1, "b" : 10}'));"""
            sql """insert into ${table_name} values (12, parse_to_variant('[123.2]')),(1022, parse_to_variant('{"a" : 1, "b" : 10}')),(1029, parse_to_variant('{"a" : 1, "b" : {"c" : 1}}'));"""
        ...
        sql "insert into simple_variant_DUPLICATE select k, parse_to_variant(cast(v as string)) from simple_variant_UNIQUE;"

        // 2. type confilct cases
        def table_name = "type_conflict_resolution"
        create_table table_name
        sql """insert into ${table_name} values (1, parse_to_variant('{"c" : "123"}'));"""
        sql """insert into ${table_name} values (2, parse_to_variant('{"c" : 123}'));"""
        sql """insert into ${table_name} values (3, parse_to_variant('{"cc" : [123.2]}'));"""
        sql """insert into ${table_name} values (4, parse_to_variant('{"cc" : [123.1]}'));"""
        sql """insert into ${table_name} values (5, parse_to_variant('{"ccc" : 123}'));"""
        sql """insert into ${table_name} values (6, parse_to_variant('{"ccc" : 123321}'));"""
        sql """insert into ${table_name} values (7, parse_to_variant('{"cccc" : 123.22}'));"""
        sql """insert into ${table_name} values (8, parse_to_variant('{"cccc" : 123.11}'));"""
        sql """insert into ${table_name} values (9, parse_to_variant('{"ccccc" : [123]}'));"""
        sql """insert into ${table_name} values (10, parse_to_variant('{"ccccc" : [123456789]}'));"""
        sql """insert into ${table_name} values (11, parse_to_variant('{"b" : 1111111111111111}'));"""
        sql """insert into ${table_name} values (12, parse_to_variant('{"b" : 1.222222}'));"""
        sql """insert into ${table_name} values (13, parse_to_variant('{"bb" : 1}'));"""
        sql """insert into ${table_name} values (14, parse_to_variant('{"bb" : 214748364711}'));"""
        sql """insert into ${table_name} values (15, parse_to_variant('{"A" : 1}'));"""
        ...
        create_table table_name
        sql """insert into ${table_name} values (1, parse_to_variant('{"A" : 123}'));"""
        sql """insert into ${table_name} values (2, parse_to_variant('{"A" : 1}'));"""
        sql """insert into ${table_name} values (4, parse_to_variant('{"A" : 123456}'));"""
        sql """insert into ${table_name} values (8, parse_to_variant('{"A" : 123456789101112}'));"""
        qt_sql_2 "select v['A'] from ${table_name} order by cast(v['A'] as bigint)"
        sql """insert into ${table_name} values (12, parse_to_variant('{"AA" : [123456]}'));"""
        sql """insert into ${table_name} values (14, parse_to_variant('{"AA" : [123456789101112]}'));"""
        ...
        sql """insert into ${table_name} values (16, parse_to_variant('{"a" : 123.22, "A" : 191191, "c": 123}'));"""
        sql """insert into ${table_name} values (18, parse_to_variant('{"a" : "123", "c" : 123456}'));"""
        sql """insert into ${table_name} values (20, parse_to_variant('{"a" : 1.10111, "A" : 1800, "c" : [12345]}'));"""
        // sql """insert into ${table_name} values (12,  '{"a" : [123]}, "c": "123456"');"""
        sql """insert into ${table_name} values (22, parse_to_variant('{"a" : 1.1111, "A" : 17211, "c" : 111111}'));"""
        sql "sync"
        ...
        sql """insert into simple_select_variant values (12, parse_to_variant('{"oamama": 1.1}'))"""
        ...
        sql """insert into simple_select_variant values (11, parse_to_variant('{"x": [123456]}'));"""
        sql """insert into simple_select_variant values (12, parse_to_variant('{"x": [123456789101112]}'));"""
        sql """insert into simple_select_variant values (12, parse_to_variant('{"xxx" : 123, "yyy" : 456}'));"""
        ...
        sql """
                ...
                properties("replication_num" = "1", "disable_auto_compaction" = "false");
            """
        sql """insert into ${table_name} values (1, parse_to_variant('{"A" : 123}'), parse_to_variant('{"B" : 123}'), parse_to_variant('{"C" : 456}'));"""
        sql """insert into ${table_name} values (2, parse_to_variant('{"C" : "123"}'), parse_to_variant('{"D" : [123]}'), parse_to_variant('{"E" : 789}'));"""
        sql """insert into ${table_name} values (3, parse_to_variant('{"C" : "123"}'), parse_to_variant('{"C" : [123]}'), parse_to_variant('{"E" : "789"}'));"""
        sql "sync"
        verify table_name
        ...
        create_table table_name
        sql """INSERT INTO t_json_parallel SELECT *, parse_to_variant('{"k1":1, "k2": "some", "k3" : [1234], "k4" : 1.10000, "k5" : [[123]]}') FROM numbers("number" = "50000");"""
        ...
        create_table table_name
        sql """INSERT INTO empty_string VALUES (1, ''), (2, parse_to_variant('{"k1": 1, "k2": "v1"}')), (3, parse_to_variant('{}')), (4, parse_to_variant('{"k1": 2}'));"""
        sql """INSERT INTO empty_string VALUES (3, null), (4, parse_to_variant('{"k1": 1, "k2": "v1"}')), (3, parse_to_variant('{}')), (4, parse_to_variant('{"k1": 2}'));"""
        sql """INSERT INTO empty_string VALUES (3, null), (4, null), (3, parse_to_variant('{}')), (4, parse_to_variant('{"k1": 2}'));"""
        sql """INSERT INTO empty_string VALUES (3, ''), (4, null), (3, parse_to_variant('{}')), (4, null);"""
        ...
        create_table table_name
        sql """INSERT INTO ${table_name} VALUES (1, ''), (1, parse_to_variant('{"k1": 1, "k2": "v1"}')), (1, parse_to_variant('{}')), (1, parse_to_variant('{"k1": 2}'));"""
        sql "alter table ${table_name} add column v2 variant default null"
        sql """INSERT INTO ${table_name} VALUES (1, parse_to_variant('{"kyyyy" : "123"}'), parse_to_variant('{"kxkxkxkx" : [123]}')), (1, parse_to_variant('{"kxxxx" : 123}'), parse_to_variant('{"xxxxyyyy": 123}'));"""
        ...
        create_table table_name
        sql """INSERT INTO ${table_name} VALUES (1, ''), (2, parse_to_variant('{"k1": true, "k2": false}')), (3, parse_to_variant('{}')), (4, parse_to_variant('{"k1": false}'));"""
        verify table_name

        // 12. jsonb values
        table_name = "jsonb_values"
        create_table.call(table_name, "DUPLICATE", "1")
        sql """insert into ${table_name} values (1, parse_to_variant('{"a" : ["123", 123, [123]]}'))"""
        // FIXME array -> jsonb will parse error
        // sql """insert into ${table_name} values (2, '{"a" : ["123"]}')"""
        sql """insert into ${table_name} values (3, parse_to_variant('{"a" : "123"}'))"""
        sql """insert into ${table_name} values (4, parse_to_variant('{"a" : 123456}'))"""
        sql """insert into ${table_name} values (5, parse_to_variant('{"a" : [123, "123", 1.11111]}'))"""
        sql """insert into ${table_name} values (6, parse_to_variant('{"a" : [123, 1.11, "123"]}'))"""
        sql """insert into ${table_name} values(7, parse_to_variant('{"a" : [123, {"xx" : 1}], "b" : {"c" : 456, "d" : null, "e" : 7.111}}'))"""
        // FIXME data bellow is invalid at present
        // sql """insert into ${table_name} values (8, '{"a" : [123, 111........]}')"""
        sql """insert into ${table_name} values (9, parse_to_variant('{"a" : [123, {"a" : 1}]}'))"""
        sql """insert into ${table_name} values (10, parse_to_variant('{"a" : [{"a" : 1}, 123]}'))"""
        ...
        create_table table_name
        sql """insert into sparse_columns select * from (select 0, parse_to_variant('{"a": 11245, "b" : [123, {"xx" : 1}], "c" : {"c" : 456, "d" : null, "e" : 7.111}}') as json_str
            union all select 1, parse_to_variant('{"a": 1123}') as json_str union all select 2, parse_to_variant('{"a" : 1234, "xxxx" : "kaana"}') as json_str from numbers("number" = "4096"))t order by 1 limit 4096 ;"""
        qt_sql_30 """ select v from sparse_columns where json_extract_string(cast(v as jsonb), "\$") != "{}" order by cast(v as string) limit 10"""
        sql "truncate table sparse_columns"
        sql """insert into sparse_columns select * from (select 0, parse_to_variant('{"a": 1123, "b" : [123, {"xx" : 1}], "c" : {"c" : 456, "d" : null, "e" : 7.111}, "zzz" : null, "oooo" : {"akakaka" : null, "xxxx" : {"xxx" : 123}}}') as json_str
            union all select 1, parse_to_variant('{"a" : 1234, "xxxx" : "kaana", "ddd" : {"aaa" : 123, "mxmxm" : [456, "789"]}}') as json_str from numbers("number" = "4096"))t order by 1 limit 4096 ;"""
        qt_sql_31 """ select v from sparse_columns where json_extract_string(cast(v as jsonb), "\$") != "{}" order by cast(v as string) limit 10"""
        sql "truncate table sparse_columns"
        ...
        sql """insert into ${table_name} values (1, parse_to_variant('{"a" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (2, parse_to_variant('{"b" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (2, parse_to_variant('{"c" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (3, parse_to_variant('{"d" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (3, parse_to_variant('{"e" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (4, parse_to_variant('{"f" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (4, parse_to_variant('{"g" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (5, parse_to_variant('{"h" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (5, parse_to_variant('{"i" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (6, parse_to_variant('{"j" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        sql """insert into ${table_name} values (6, parse_to_variant('{"k" : 1}')), (1, parse_to_variant('{"a" : 1}'))"""
        ...
        sql """UPDATE ${table_name} set v = parse_to_variant('{"updated_value" : 10}') where k = 2"""
        ...
        create_table.call(table_name,  "DUPLICATE", "1")
        sql """insert into ${table_name} values (1, parse_to_variant('{"a" : 1}')), (1, parse_to_variant('{"a":  "1"}'))"""
        sql """insert into ${table_name} values (1, parse_to_variant('{"a" : 1}')), (1, parse_to_variant('{"a":  "2"}'))"""
        ...
        """
        sql """insert into ${table_name} values (1, "abc", parse_to_variant('{"a" : 1}')), (1, "cde", parse_to_variant('{"b" : 1}'))"""
        sql """insert into ${table_name} values (2, "abe", parse_to_variant('{"c" : 1}'))"""
        sql """insert into ${table_name} values (3, "abd", parse_to_variant('{"d" : 1}'))"""
        ...
        sql """
            insert into variant_cast values
                (1, parse_to_variant('["CXO0N: 1045901740", "HMkTa: 1348450505", "44 HHD: 915015173", "j9WoJ: -1517316688"]')),
                (2, parse_to_variant('"[1]"')),
                (3, parse_to_variant('123456')),
                (4, parse_to_variant('1.11111'))
        """
        ...
        def groupByVariantSubpath = sql """
            select cast(v['a'] as string), count(*)
            from ${table_name}
            group by v['a']
            order by cast(v['a'] as string)
        """
        assertEquals([[null, 4L]], groupByVariantSubpath)
        ...
        """
        sql """insert into var_as_key values(1, parse_to_variant('{"a" : 10}'))"""
        sql """insert into var_as_key values(2, parse_to_variant('{"b" : 11}'))"""
        ...
        """
        sql """ insert into ${table_name} values (1, parse_to_variant('{"a": 1122323232313223, "b": 1.2, "c" : "ddddd", "d" : {"e": 1.2, "f": "ggggg"}}')), (2, NULL) """
        def variantTypes = sql """ select variant_type(v) from ${table_name} order by k """
        assertEquals([["object"], [null]], variantTypes)
    } finally {
        // reset flags
    }
}
