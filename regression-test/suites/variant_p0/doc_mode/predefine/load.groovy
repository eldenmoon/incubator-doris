...
suite("test_variant_predefine_doc_value", "nonConcurrent"){
    ...
    sql """insert into test_predefine values(1, '1', parse_to_variant('{"a" : {"b" : {"c" : "123456", "d" : "11.111"}}, "ss" : 199991111, "dcm" : 123.456, "dt" : "2021-01-01 00:00:00", "ip" : "127.0.0.1"}'))"""
    sql """insert into test_predefine values(2, '2', parse_to_variant('{"a" : {"b" : {"c" : 678910, "d" : 22.222}}, "ss" : "29999111", "dcm" : "456.123", "dt" : "2022-01-01 11:11:11", "ip" : "127.0.0.1"}'))"""
    sql """insert into test_predefine values(3, '3', parse_to_variant('{"dcm" : 789.123, "dt" : "2025-01-01 11:11:11.1", "ip" : "127.0.0.1"}'))"""
    sql """insert into test_predefine values(4, '4', parse_to_variant('{"a" : {"b" : {"c" : "678910", "d" : "33.222"}}}'))"""
    sql """insert into test_predefine values(5, '5', null)"""
    sql """insert into test_predefine values(6, '6', null)"""
    sql """insert into test_predefine values(7, '7', parse_to_variant('{"xxx" : 12345}'))"""
    sql """insert into test_predefine values(8, '8', parse_to_variant('{"yyy" : 111.111}'))"""
    sql """insert into test_predefine values(9, '2', parse_to_variant('{"a" : {"b" : {"c" : 678910, "d" : 22.222}}, "ss" : "29999111", "dcm" : "456.123", "dt" : "2022-01-01 11:11:11", "ip" : "127.0.0.1"}'))"""
    sql """insert into test_predefine values(10, '1', parse_to_variant('{"a" : {"b" : {"c" : "123456", "d" : "11.111"}}, "ss" : 199991111, "dcm" : 123.456, "dt" : "2021-01-01 00:00:00", "ip" : "127.0.0.1"}'))"""
    sql """insert into test_predefine values(12, '3', parse_to_variant('{"dcm" : 789.123, "dt" : "2025-01-01 11:11:11.1", "ip" : "127.0.0.1"}'))"""
    sql """insert into test_predefine values(11, '4', parse_to_variant('{"a" : {"b" : {"c" : "678910", "d" : "33.222"}}}'))"""
    ...
    qt_sql """select cast(v1['dcm'] as double) from test_predefine where cast(v1['dcm'] as double) = '123.456';"""
    qt_sql """select v1['dcm'] from test_predefine where length(cast(v1['dcm'] as string)) > 0 order by id;"""
    qt_sql """select v1['dt'] from test_predefine where cast(v1['dt'] as string) = '2022-01-01 11:11:11';"""
    qt_sql """select v1['dt'] from test_predefine  where  cast(v1['dt'] as string) = '2022-01-01 11:11:11' order by id limit 10"""
    qt_sql """select * from test_predefine  where  cast(v1['dt'] as string) = '2022-01-01 11:11:11' order by id limit 10;"""
    ...
    """ 
    sql """insert into test_predefine1 values(1, parse_to_variant('{"predefine_col1" : 1024}'))"""
    sql """insert into test_predefine1 values(2, parse_to_variant('{"predefine_col2" : 1.11111}'))"""
    sql """insert into test_predefine1 values(3, parse_to_variant('{"predefine_col3" : "11111.00000"}'))"""
    sql """insert into test_predefine1 values(4, parse_to_variant('{"predefine_col4" : "2020-01-01-01"}'))"""

    sql """insert into test_predefine1 values(5, parse_to_variant('{"PREDEFINE_COL1" : 1024}'))"""
    sql """insert into test_predefine1 values(6, parse_to_variant('{"PREDEFINE_COL2" : 1.11111}'))"""
    sql """insert into test_predefine1 values(7, parse_to_variant('{"PREDEFINE_COL3" : "11111.00000"}'))"""
    sql """insert into test_predefine1 values(8, parse_to_variant('{"PREDEFINE_COL4" : "2020-01-01-01"}'))"""
    ...
    sql """
        CREATE TABLE `test_predefine2` (
            ...
            `v1` variant<
                ...
                'array_decimal':array<double>,
                'array_datetime':array<string>,
                'array_datetimev2':array<string>,
                'array_date':array<string>,
                'array_datev2':array<string>,
                'array_ipv4':array<string>,
                'array_ipv6':array<string>,
                'array_float':array<double>,
    ...
    """
    sql "insert into test_predefine2 values(1, parse_to_variant('${json1}'))"
    sql "insert into test_predefine2 values(2, parse_to_variant('${json2}'))"
    sql "insert into test_predefine2 values(3, parse_to_variant('${json3}'))"
    sql "insert into test_predefine2 values(4, parse_to_variant('${json4}'))"
       
    qt_sql """select * from test_predefine2 order by id"""

    for (int i = 10; i < 100; i++) {
        sql "insert into test_predefine2 values(${i}, parse_to_variant('${json4}'))"
    } 

    // // schema change
    // // 1. add column
    sql "alter table test_predefine1 add column v2 variant<'dcm':double,'dt':string> default null"
    sql """insert into test_predefine1 values(101, parse_to_variant('{"a" :1}'), parse_to_variant('{"dcm": 1111111}'))"""
    sql "alter table test_predefine1 add column v3 variant<'dcm':double,'dt':string,'ip':string> default null"
    sql """insert into test_predefine1 values(102, parse_to_variant('{"a" :1}'), parse_to_variant('{"dcm": 1111111}'), parse_to_variant('{"dcm": 1111111}'));"""
    // 2. todo support alter column type
    // sql "alter table test_predefine1 modify column v3 variant<dcm:decimal,dt:datetime,ip:ipv6>"
    sql """insert into test_predefine1 values(103, parse_to_variant('{"a" :1}'), parse_to_variant('{"dcm": 1111111}'), parse_to_variant('{"dt": "2021-01-01 11:11:11"}'));"""
    ...
    sql """insert into test_predefine3 values (1, parse_to_variant('{"nested" : [{"a" : 123, "b" : "456"}]}'))"""
    ...
    sql "truncate table test_predefine3"
    sql """insert into test_predefine3 values (1, parse_to_variant('{"auto_type" : 1234.1111}'))"""
    // sql "alter table test_predefine3 modify column v variant<`auto_type`: int>"
    sql """insert into test_predefine3 values (1, parse_to_variant('{"auto_type" : "124511111"}'))"""
    sql """insert into test_predefine3 values (1, parse_to_variant('{"auto_type" : 1111122334}'))"""
    sql """insert into test_predefine3 values (1, parse_to_variant('{"auto_type" : 111223341111}'))"""
    sql """insert into test_predefine3 values (1, parse_to_variant('{"auto_type" : true}'))"""
    sql """insert into test_predefine3 values (1, parse_to_variant('{"auto_type" : 1}'))"""
    sql """insert into test_predefine3 values (1, parse_to_variant('{"auto_type" : 256}'))"""
    sql """insert into test_predefine3 values (1, parse_to_variant('{"auto_type" : 12345}'))"""
    sql """insert into test_predefine3 values (1, parse_to_variant('{"auto_type" : 1.0}'))"""
    ...
    sql """
      ...
      `k` bigint NULL,
      `var` variant<match_name 'array_decimal':array<double>>
    ) ENGINE=OLAP
    DUPLICATE KEY(`k`)
    ...
    """
    sql """insert into test_array_with_nulls values(3, parse_to_variant('{"array_decimal" : [null, 2.2, 3.3, 4.4]}'))"""
    qt_sql_arr_null_1 "select * from test_array_with_nulls order by k"
    sql """insert into test_array_with_nulls values(1, parse_to_variant('{"array_decimal" : [1.1, 2.2, 3.3, null]}'))"""
    sql """insert into test_array_with_nulls values(2, parse_to_variant('{"array_decimal" : [1.1, 2.2, null, 4.4]}'))"""
    sql """insert into test_array_with_nulls values(4, parse_to_variant('{"array_decimal" : [1.1, null, 3.3, 4.4]}'))"""
    sql """insert into test_array_with_nulls values(5, parse_to_variant('{"array_decimal" : [1.1, 2.2, 3.3, 4.4]}'))"""
    sql """insert into test_array_with_nulls values(6, parse_to_variant('{"array_decimal" : []}'))"""
    sql """insert into test_array_with_nulls values(7, parse_to_variant('{"array_decimal" : [null, null]}'))"""
    ...
    sql """
      ...
      `k` bigint NULL,
      `var` variant<match_name 'dcm' : double, 'db' : double, 'dt' : string, 'a.b.c' : array<int>>
    ) ENGINE=OLAP
    DUPLICATE KEY(`k`)
    DISTRIBUTED BY HASH(`k`) BUCKETS 1
    PROPERTIES (
    ...
    """
    sql """insert into test_variant_type values(1, parse_to_variant('{"dcm" : 1.1, "db" : 2.2, "dt" : "2021-01-01 00:00:00", "a.b.c" : [1, 2, 3]}'))"""
    ...
    sql """
      ...
      `k` bigint NULL,
      `var` variant<match_name 'dcm' : double, 'db' : double, 'dt' : string, 'a.b.c' : array<int>> not null
    ) ENGINE=OLAP
    DUPLICATE KEY(`k`)
    DISTRIBUTED BY HASH(`k`) BUCKETS 1
    PROPERTIES (
    ...
    """
    sql """insert into test_variant_type_not_null values(1, parse_to_variant('{"dcm" : 1.1, "db" : 2.2, "dt" : "2021-01-01 00:00:00", "a.b.c" : [1, 2, 3]}'))"""
}
