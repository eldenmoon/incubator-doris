...
suite("regression_test_variant_array_with_predicate", "p0"){
    ...
    """
    sql """insert into array_with_predicate values (1, parse_to_variant('{"arr" : ["1", "2", "3", "4"]}'))"""
    sql """insert into array_with_predicate values (1, parse_to_variant('{"arr" : "[]"}'))"""
    sql """insert into array_with_predicate values (1, parse_to_variant('{"arr1" : "[]"}'))"""
