...
suite("test_variant_cast", "p0") {
    ...
    """
    sql """insert into var_cast values (1, parse_to_variant('{"aaa" : 1}'))"""
    qt_sql3 "select cast(var as json) from var_cast"
    sql """insert into var_cast values (1, parse_to_variant('[1]'))"""
    qt_sql4 "select cast(var as json) from var_cast"
    sql """insert into var_cast values (1, parse_to_variant('123'))"""
    ...
    """
    sql """insert into var_not_null_cast values (1, parse_to_variant('{"aaa" : 1}'))"""
    //qt_sql6 "select cast(var as json) from var_not_null_cast"
    sql """insert into var_not_null_cast values (1, parse_to_variant('[1]'))"""
    //qt_sql7 "select cast(var as json) from var_not_null_cast"
    sql """insert into var_not_null_cast values (1, parse_to_variant('123'))"""
    //qt_sql8 "select cast(var as json) from var_not_null_cast"
    sql """insert into var_not_null_cast values (1, parse_to_variant('{"aaa" : "aaa"}'))"""
    ...
    """
    sql """insert into var_cast_decimal values (1, parse_to_variant('{"aaa" : 1.23}'))"""
