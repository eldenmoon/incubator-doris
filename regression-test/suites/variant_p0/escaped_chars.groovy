...
suite("regression_test_variant_escaped_chars", "p0"){
    ...
    sql """
        ...
        (1, parse_to_variant('{"a" : 123, "b" : "test with escape \\\\" characters"}')),
        (2, parse_to_variant('{"a" : 456, "b" : "another test with escape \\\\\\\\ characters"}')),
        (3, parse_to_variant('{"a" : 789, "b" : "test with single quote \\\' characters"}')),
        (4, parse_to_variant('{"a" : 101112, "b" : "test with newline \\\\n characters"}')),
        (5, parse_to_variant('{"a" : 131415, "b" : "test with tab \\\\t characters"}')),
        (6, parse_to_variant('{"a" : 161718, "b" : "test with backslash \\\\b characters"}'));
    """
    ...
    sql """
        ...
        insert into t01 values (1, '{"c_json":{"a":"a\\\\nb"}}', '{"c_json": {"quote":"\\\\"Helvetica tofu try-hard gluten-free gentrify leggings.\\\\" - Remington Trantow"}}', parse_to_variant('{"c_json": {"quote":"\\\\"Helvetica tofu try-hard gluten-free gentrify leggings.\\\\" - Remington Trantow"}}'), parse_to_variant('{"c_json":{"a":"a\\\\nb"}}'));
    """
