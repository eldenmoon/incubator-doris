...
suite("test_variant_arrayInvertedIdx_profile", "p0,nonConcurrent"){
    ...
    """
        ...
        sql """ INSERT INTO `var_arr_idx` (`apply_date`, `id`, `inventors`) VALUES
            ('2017-01-01', '6afef581285b6608bf80d5a4e46cf839', parse_to_variant('{"inventors":["a", "b", "c"]}')),
            ('2017-01-01', '8fcb57ae675f0af4d613d9e6c0e8a2a3', parse_to_variant('{"inventors":[]}')),
            ('2017-01-01', 'd93d942d985a8fb7547c72dada8d332d', parse_to_variant('{"inventors": ["d", "e", "f", "g", "h", "i", "j", "k", "l"]}')),
            ('2017-01-01', '8fcb57ae675f0af4d613d9e6c0e8a2a4', NULL),
            ('2017-01-01', 'd93d942d985a8fb7547c72dada8d332e', parse_to_variant('{"inventors": ["m", "n", "o", "p", "q", "r", "s", "t", "u"]}')),
            ('2017-01-01', '8fcb57ae675f0af4d613d9e6c0e8a2a6', parse_to_variant('{"inventors": [null,null,null]}')),
            ('2019-01-01', 'd93d942d985a8fb7547c72dada8d332f', parse_to_variant('{"inventors": ["v", "w", "x", "y", "z"]}')); """
