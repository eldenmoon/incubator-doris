...
suite("test_compaction_uniq_keys_row_store") {
    ...
    try {
        ...
        sql """ INSERT INTO ${tableName} VALUES
            ...
            """
        qt_sql_row_size "select sum(length(__DORIS_ROW_STORE_COL__)), sum(length(__DORIS_ROW_STORE_COL__group1)) from regression_test_serving_p0.compaction_uniq_keys_row_store_regression_test"
