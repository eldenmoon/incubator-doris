...
/**
 * ScalarFunction 'jsonb_extract'. This class is generated by GenerateFunction.
 */
public class JsonbExtract extends ScalarFunction
    ...
    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            ...
            FunctionSignature.ret(VariantType.INSTANCE).args(VariantType.INSTANCE, VarcharType.SYSTEM_DEFAULT),
            FunctionSignature.ret(VariantType.INSTANCE).args(VariantType.INSTANCE, StringType.INSTANCE)
    );
    ...
    public Expression rewriteWhenAnalyze() {
        if (children.get(0).getDataType().isVariantType()) {
            return VariantJsonNativeRewrite.get(children.get(0), children.get(1));
        }
        return this;
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitJsonbExtract(this, context);
    }
}
