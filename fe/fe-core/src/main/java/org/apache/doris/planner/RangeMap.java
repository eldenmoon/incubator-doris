...
public class RangeMap<C extends Comparable<C>, V> {
    ...
    //     rangeMap.put(Range.closed(1, 5), "Range 1-5");
    //     rangeMap.put(Range.closed(6, 10), "Range 6-10");

    //     Range<Integer> searchRange = Range.closed(3, 7);
    //     List<Map.Entry<Range<Integer>, String>> overlappingRanges = rangeMap.getOverlappingRanges(searchRange);

    //     for (Map.Entry<Range<Integer>, String> entry : overlappingRanges) {
    //         System.out.println("Overlapping Range: " + entry.getKey() + ", Value: " + entry.getValue());
    //     }
    // }
}
