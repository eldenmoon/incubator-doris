...
/** Parse JSON into a Variant value and return SQL NULL for input errors. */
public class TryParseToVariant extends ScalarFunction
        implements UnaryExpression, NullOrIdenticalSignature, AlwaysNullable {

    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            FunctionSignature.ret(VariantType.INSTANCE).args(VarcharType.SYSTEM_DEFAULT),
            FunctionSignature.ret(VariantType.INSTANCE).args(JsonType.INSTANCE)
    );
