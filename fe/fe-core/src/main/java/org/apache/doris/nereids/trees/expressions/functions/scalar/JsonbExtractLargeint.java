...
public class JsonbExtractLargeint extends ScalarFunction
    ...
    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            ...
            FunctionSignature.ret(LargeIntType.INSTANCE).args(VariantType.INSTANCE, VarcharType.SYSTEM_DEFAULT),
            FunctionSignature.ret(LargeIntType.INSTANCE).args(VariantType.INSTANCE, StringType.INSTANCE)
    );
